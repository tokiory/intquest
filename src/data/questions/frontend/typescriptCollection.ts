...
const typescriptQuestionCollection: QuestionSection = {
  ...
  collection: [
    ...
    {
      name: 'Как создавать и использовать классы в TypeScript?',
      slug: slugs.classes,
      answer: [
        'Классы в TypeScript позволяют создавать объекты с определенной структурой и поведением. Они поддерживают наследование, инкапсуляцию и полиморфизм.',
      ],
      tags: [
        tags.junior,
        tags.fundamentals,
